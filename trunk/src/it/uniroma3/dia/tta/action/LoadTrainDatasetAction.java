 ...
 * 
 */
public class LoadTrainDatasetAction extends Action {
	...
	chooser.setFileFilter(txtFilter);
        ...
        if (code == JFileChooser.APPROVE_OPTION) {
            ...
            TwitterTextAnalyzer.getApp().getTrainPath_text().setText(file.getName());
            TwittSetLoader loader = new TwittSetLoader(file, true);
            loader.start();
        }
        return null;
    }
